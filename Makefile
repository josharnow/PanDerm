...
linear_eval_phase_1:
	...
	ulimit -n 4096; \
	OPENBLAS_NUM_THREADS=$(OPENBLAS_NUM_THREADS) VECLIB_MAXIMUM_THREADS=$(VECLIB_MAXIMUM_THREADS) NUMEXPR_NUM_THREADS=$(NUMEXPR_NUM_THREADS) OMP_NUM_THREADS=$(OMP_NUM_THREADS) MKL_NUM_THREADS=$(MKL_NUM_THREADS) PYTORCH_NUM_THREADS=$(PYTORCH_NUM_THREADS) $(PYTHON) linear_eval.py \
