...
class ContextAutoencoderViT(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768, depth=12,
        ...
        super().__init__()
        # print('1111111111',embed_dim,decoder_embed_dim) #1024,768
        # print('2222222',kwargs['args'].decoder_embed_dim ) #1024
        # print('33333333',decoder_num_heads,num_heads,depth) #12,16,24
