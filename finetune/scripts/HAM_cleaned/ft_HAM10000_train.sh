...
MODEL_PATH=/home/syyan/XJ/PanDerm-open_source/pretrain_weight/panderm-large.pth
...
CUDA_VISIBLE_DEVICES=2 python3 run_class_finetuning.py \
    ...
    --output_dir "/home/syyan/XJ/PanDerm-open_source/finetune/work_dir/HAM10000_cleaned" \
    --csv_path /home/syyan/XJ/PanDerm-open_source/data/finetune/HAM10000/HAM_cleaned_training.csv \
